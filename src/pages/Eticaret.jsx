  ...
  return (
    <div className='mt-12'>
      <div className='flex flex-wrap lg:flex-nowrap justify-center'>
        ...
        pt-9 m-3 bg-hero-pattern1 bg-no-repeat bg-cover bg-center'>
          <div className='flex justify-between items-center'>
            <div>
            <p className='font-bold text-gray-400'>Kazanç</p>
            <p className='text-2xl'>$63,448.44</p>
          </div>
        </div>
        <div className='mt-6'>
          <Button color="white"
      ...
      <div className='flex m-3 flex-wrap justify-center gap-1 items-center'>
        {earningData.map((item)=>(
          ...
          p-4 pt-9 rounded-2xl'>
            ...
            opacity-0.9 rounded-full hover:drop-shadow-xl'>
              {item.icon}
            </button>
            <p className='mt-3'>
