...
import { AccumulationChartComponent,
   AccumulationSeriesCollectionDirective, AccumulationSeriesDirective,
    Inject, AccumulationLegend, AccumulationDataLabel, 
    AccumulationTooltip, PyramidSeries, AccumulationSelection
...
const Piramid = () => {
  ...
  return (
    ...
    <Header category="Piramid" title="Gıda Karşılaştırma Tablosu" />
    <div className="w-full">
      ...
      >
        <Inject services={[AccumulationDataLabel, 
          AccumulationTooltip, PyramidSeries, AccumulationLegend,
